    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('medicos.index')}}">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('medicamentos.index')}}">Medicamentos</a>
                        </div>
                    </div>
                </li>
                <hr class="sidebar-divider">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('pesqpacrec.index')}}">
                        <i class="fas fa-fw fa-plus"></i>
                        <span>Gerar Receita</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('listareceitas.index')}}">
                        <i class="fas fa-fw fa-search"></i>
                        <span>Pesquisar Receita</span></a>
                </li>
                    ...
                    <form id="form-perfil" method="post" action="{{route('medico.editar', $id_usuario)}}">
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$usuario->telefone}}" type="text" class="form-control" id="telefone" name="telefone" placeholder="telefone">
                                    </div>
                                    <div class="form-group">
                                        <label >Email</label>
