...
$dados_paciente=farmacia::where('email','=',@$_SESSION['email_usuario'])->first();
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homefar.index')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{route('indicepacientes.index')}}" >
